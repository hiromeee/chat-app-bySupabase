        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                ...
                {/* Section 1: Channels & DMs */}
                <div className="space-y-2">
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-indigo-500">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        メッセージに <code className="bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded text-xs font-mono border border-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-800">@ai</code> を含めて送信すると、AI (Gemini) が自動的に応答します。質問や相談など、自由に話しかけてみてください。
                    </p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <ul className="list-disc list-inside text-sm text-slate-600 dark:text-slate-400 ml-2 space-y-1">
                        ...
                        <li>```言語名 でコードブロック (シンタックスハイライト対応)</li>
                    </ul>
                </div>
